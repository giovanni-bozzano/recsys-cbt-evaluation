from conferences.IJCAI.cbt.datasets_provided.nf_sparse_to_bx_reader import NetflixSparseToBookCrossingReader
from Data_manager.DataReader import DataReader
from Data_manager.Dataset import Dataset


class NetflixSparseToBookCrossingReaderWrapper(DataReader):
    DATASET_SUBFOLDER = 'NetflixSparseToBookCrossingReader_Wrapper/'
    AVAILABLE_URM = ['URM_all']
    IS_IMPLICIT = False

    def __init__(self):
        super(NetflixSparseToBookCrossingReaderWrapper, self).__init__()
        self._originalReader = NetflixSparseToBookCrossingReader()
