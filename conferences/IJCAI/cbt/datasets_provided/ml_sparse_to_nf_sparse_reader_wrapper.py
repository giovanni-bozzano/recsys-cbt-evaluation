from conferences.IJCAI.cbt.datasets_provided.ml_sparse_to_nf_sparse_reader import MovieLensSparseToNetflixSparseReader
from Data_manager.DataReader import DataReader
from Data_manager.Dataset import Dataset


class MovieLensSparseToNetflixSparseReaderWrapper(DataReader):
    DATASET_SUBFOLDER = 'MovieLensSparseToNetflixSparseReader_Wrapper/'
    AVAILABLE_URM = ['URM_all']
    IS_IMPLICIT = False

    def __init__(self):
        super(MovieLensSparseToNetflixSparseReaderWrapper, self).__init__()
        self._originalReader = MovieLensSparseToNetflixSparseReader()
    ...
    def _load_from_original_file(self):
        ...
        print('TARGET Netflix Prize Sparse')
