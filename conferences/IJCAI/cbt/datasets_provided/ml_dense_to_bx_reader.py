...
class MovieLensDenseToBookCrossingReader(object):
    URM_dictionary = {}

    def __init__(self):
        super(MovieLensDenseToBookCrossingReader, self).__init__()

        original_data_path = 'conferences/IJCAI/cbt/data/'

        URM_source, URM_target = parse_data.parse(original_data_path + 'urm_ml_dense.mat', 'ml_dense',
        ...
        print('MovieLensDenseToBookCrossingReader: loading complete')
