from conferences.IJCAI.cbt.datasets_provided.ml_dense_to_bx_reader import MovieLensDenseToBookCrossingReader
from Data_manager.DataReader import DataReader
from Data_manager.Dataset import Dataset


class MovieLensDenseToBookCrossingReaderWrapper(DataReader):
    DATASET_SUBFOLDER = 'MovieLensDenseToBookCrossingReader_Wrapper/'
    AVAILABLE_URM = ['URM_all']
    IS_IMPLICIT = False

    def __init__(self):
        super(MovieLensDenseToBookCrossingReaderWrapper, self).__init__()
        self._originalReader = MovieLensDenseToBookCrossingReader()
