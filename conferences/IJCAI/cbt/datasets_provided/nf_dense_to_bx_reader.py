...
class NetflixDenseToBookCrossingReader(object):
    URM_dictionary = {}

    def __init__(self):
        super(NetflixDenseToBookCrossingReader, self).__init__()
        ...
        print('NetflixDenseToBookCrossingReader: loading complete')
