...
class MovieLensSparseToBookCrossingReader(object):
    URM_dictionary = {}

    def __init__(self):
        super(MovieLensSparseToBookCrossingReader, self).__init__()
        ...
        URM_source, URM_target = parse_data.parse(original_data_path + 'urm_ml_sparse.mat', 'ml_sparse',
                                                  original_data_path + 'urm_bx_sparse.mat', 'bx_sparse')
        ...
        print('MovieLensSparseToBookCrossingReader: loading complete')
