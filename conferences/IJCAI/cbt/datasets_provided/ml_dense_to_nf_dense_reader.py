...
class MovieLensDenseToNetflixDenseReader(object):
    URM_dictionary = {}

    def __init__(self):
        super(MovieLensDenseToNetflixDenseReader, self).__init__()
        ...
        URM_source, URM_target = parse_data.parse(original_data_path + 'urm_ml_dense.mat', 'ml_dense',
                                                  original_data_path + 'urm_nf_dense.mat', 'nf_dense')
        ...
        print('MovieLensDenseToNetflixDenseReader: loading complete')
