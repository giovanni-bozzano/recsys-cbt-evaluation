...
class NetflixSparseToBookCrossingReader(object):
    URM_dictionary = {}

    def __init__(self):
        super(NetflixSparseToBookCrossingReader, self).__init__()
        ...
        print('NetflixSparseToBookCrossingReader: loading complete')
