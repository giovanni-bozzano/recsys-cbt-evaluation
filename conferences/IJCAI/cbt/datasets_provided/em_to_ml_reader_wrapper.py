from conferences.IJCAI.cbt.datasets_provided.em_to_ml_reader import EachMovieToMovieLensReader
from Data_manager.DataReader import DataReader
from Data_manager.Dataset import Dataset


class EachMovieToMovieLensReaderWrapper(DataReader):
    DATASET_SUBFOLDER = 'EachMovieToMovieLensReader_Wrapper/'
    AVAILABLE_URM = ['URM_all']
    IS_IMPLICIT = False

    def __init__(self):
        super(EachMovieToMovieLensReaderWrapper, self).__init__()
        self._originalReader = EachMovieToMovieLensReader()
