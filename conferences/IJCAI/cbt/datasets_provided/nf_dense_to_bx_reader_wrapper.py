from conferences.IJCAI.cbt.datasets_provided.nf_dense_to_bx_reader import NetflixDenseToBookCrossingReader
from Data_manager.DataReader import DataReader
from Data_manager.Dataset import Dataset


class NetflixDenseToBookCrossingReaderWrapper(DataReader):
    DATASET_SUBFOLDER = 'NetflixDenseToBookCrossingReader_Wrapper/'
    AVAILABLE_URM = ['URM_all']
    IS_IMPLICIT = False

    def __init__(self):
        super(NetflixDenseToBookCrossingReaderWrapper, self).__init__()
        self._originalReader = NetflixDenseToBookCrossingReader()
