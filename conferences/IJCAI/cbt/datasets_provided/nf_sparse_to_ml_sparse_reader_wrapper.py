from conferences.IJCAI.cbt.datasets_provided.nf_sparse_to_ml_sparse_reader import NetflixSparseToMovieLensSparseReader
from Data_manager.DataReader import DataReader
from Data_manager.Dataset import Dataset


class NetflixSparseToMovieLensSparseReaderWrapper(DataReader):
    DATASET_SUBFOLDER = 'NetflixSparseToMovieLensSparseReader_Wrapper/'
    AVAILABLE_URM = ['URM_all']
    IS_IMPLICIT = False

    def __init__(self):
        super(NetflixSparseToMovieLensSparseReaderWrapper, self).__init__()
        self._originalReader = NetflixSparseToMovieLensSparseReader()
    ...
    def _load_from_original_file(self):
        ...
        print('================')
        print('SOURCE Netflix Prize Sparse')
        ...
        print('TARGET MovieLens 1M Sparse')
