...
class MovieLensSparseToNetflixSparseReader(object):
    URM_dictionary = {}

    def __init__(self):
        super(MovieLensSparseToNetflixSparseReader, self).__init__()

        original_data_path = 'conferences/IJCAI/cbt/data/'

        URM_source, URM_target = parse_data.parse(original_data_path + 'urm_ml_sparse.mat', 'ml_sparse',
                                                  original_data_path + 'urm_nf_sparse.mat', 'nf_sparse')
        ...
        print('MovieLensSparseToNetflixSparseReader: loading complete')
