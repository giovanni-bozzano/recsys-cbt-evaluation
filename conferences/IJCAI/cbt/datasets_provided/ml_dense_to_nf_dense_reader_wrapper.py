from conferences.IJCAI.cbt.datasets_provided.ml_dense_to_nf_dense_reader import MovieLensDenseToNetflixDenseReader
from Data_manager.DataReader import DataReader
from Data_manager.Dataset import Dataset


class MovieLensDenseToNetflixDenseReaderWrapper(DataReader):
    DATASET_SUBFOLDER = 'MovieLensDenseToNetflixDenseReader_Wrapper/'
    AVAILABLE_URM = ['URM_all']
    IS_IMPLICIT = False

    def __init__(self):
        super(MovieLensDenseToNetflixDenseReaderWrapper, self).__init__()
        self._originalReader = MovieLensDenseToNetflixDenseReader()
    ...
    def _load_from_original_file(self):
        ...
        print('================')
        print('SOURCE MovieLens 1M Dense')
        ...
        print('TARGET Netflix Prize Dense')
