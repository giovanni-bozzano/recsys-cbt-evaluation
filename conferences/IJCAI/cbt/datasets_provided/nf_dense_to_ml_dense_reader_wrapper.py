from conferences.IJCAI.cbt.datasets_provided.nf_dense_to_ml_dense_reader import NetflixDenseToMovieLensDenseReader
from Data_manager.DataReader import DataReader
from Data_manager.Dataset import Dataset


class NetflixDenseToMovieLensDenseReaderWrapper(DataReader):
    DATASET_SUBFOLDER = 'NetflixDenseToMovieLensDenseReader_Wrapper/'
    AVAILABLE_URM = ['URM_all']
    IS_IMPLICIT = False

    def __init__(self):
        super(NetflixDenseToMovieLensDenseReaderWrapper, self).__init__()
        self._originalReader = NetflixDenseToMovieLensDenseReader()
    ...
    def _load_from_original_file(self):
        ...
        print('================')
        print('SOURCE Netflix Prize Dense')
        ...
        print('TARGET MovieLens 1M Dense')
